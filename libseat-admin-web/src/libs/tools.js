 ...
 * @param {Array} arr1
 * @param {Array} arr2
 * @description arry1 删除 arry 2 的部分
 */
export const remove = (arr1, arr2) => {
  return Array.from(new Set([...arr1, ...arr2]))
}
...
export function getOpenServerTime() {
  return new Date('2020-01-01 00:00:00');
}
/**
 ...
 * @returns {string}
 */
export const timestampFormat = (timeStamp,startType) => {
